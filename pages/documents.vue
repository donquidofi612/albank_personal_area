  ...
  <div>
    <div class="tw-flex tw-flex-col tw-gap-6 tw-min-h-screen">
      <div class="tw-flex tw-flex-col">
        <span class="tw-text-lg textprimary">Documents</span>
        <!--        <span>Effectuer un virement</span>-->
      </div>

      <!--//      <div class="tw-flex tw-flex-row tw-gap-2">-->
      <!--        <div class="tw-rounded tw-bg-gradient-to-r tw-from-[#003da5] tw-via-red-800 tw-to-black tw-px-4 tw-py-6 tw-flex tw-items-center tw-justify-between">-->
      ...
      <div class="tw-flex tw-flex-col md:tw-flex-row tw-gap-4">
        ...
        <div class="tw-bg-white tw-rounded-md tw-p-4 tw-flex tw-flex-col tw-justify-center tw-items-center tw-shadow-md tw-w-full md:tw-w-fit">
          <svg width="180px" height="180px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
          ...
          <p class="tw-text-center tw-font-bold">RIB PDF</p>
        </div>
        <div class="tw-bg-white tw-rounded-md tw-p-4 tw-flex tw-flex-col tw-justify-center tw-items-center tw-shadow-md tw-w-full md:tw-w-fit">
          <svg width="180px" height="180px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
          ...
          <p class="tw-text-center tw-font-bold">Informations sur la sécurité du compte</p>
        </div>
